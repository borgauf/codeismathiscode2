...
** ...in which we attempt to formalize things

Objects by themselves or objects together. No doubt many creatures
other than just us humans possess an instinctual, /intuitive/, working
grasp of these two seemingly contrasting situations. We humans have
language, and this brings logic and symbolism to intuition. Consider
the statement
...
A statement is also called a /proposition/ and must be either true or
false, as in "Let us /propose/ this to be true." The $\implies$ arrow
is from mathematical logic and means /implies/, i.e., one thing
/implies/ another thing.[fn:1] Or, roughly, "/if/ you say this, /then/
you are also saying this."  Reading the statement backwards

⇲ @@html:<font color = "#0d3db3">&nbsp;&nbsp;@@
not alone, not separate $\implies$ together
@@html:</font>@@

we notice a simple "if /not/ this then that" situation. Both are
statements, or /proposition we can decide whether they are true or not. In math logic
this is called a /proposition/. For example
...
statement that can be resolved to *true* or *false*. #2 is a command,
and #3 is a question. Of course #2 and #3 can be answered with yes or
no, but not true or false.[fn:2]

And so @@html:<font color = "#0d3db3">@@together $\implies$ not alone,
not separate@@html:</font>@@ is a statement that is either true or
false. We may simply believe it to be true, but it may not be. Lurking
somewhere might be a situation where /together/ does not really imply
or mean /not alone/ and /not separate/. What about riding on a city
transit bus? Yes, you can technically be together with all the other
passengers, but still be quite alone and separate from all the people
you do not know.
...
[fn:1] We'll describe all the math logic symbols shortly...

[fn:2] There is a story of the famous physicist Paul Dirac who,
