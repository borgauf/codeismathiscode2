...
a /typed, purely functional/ [fn:6] language. One big reason Haskell
...
absolute necessity for computational predictability.[fn:11] Being able
...
than what you expected it to do[fn:12]. By the way, there's a very big
...
calculation into concepts.[fn:15]
...
before[fn:16]. Long story shortened, math can be a very imposing
...
face in their first year in a Computer Science program[fn:31].
...
[fn:6] We'll dive into what /typed/ and /functional/ languages are
later...
...
[fn:11] We'll discuss no side effects or /referential transparency/,
...
[fn:15] Perhaps watch [[https://youtu.be/6APBx0WsgeQ?si=Hpl1zLcdjkuDtHDP][Why does Cambridge teach OCaml as the first
