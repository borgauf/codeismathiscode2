...
#+name: bb9d9079-206c-4d09-ae0a-aef93214012b
#+begin_src haskell :results verbatim :exports both
:{
xDivides6 :: Integral a => [a]  
xDivides6 = [x | x <- sampleList, ((6 `rem` x) == 0)]
  where sampleList = [-20,-19..(-1)] ++ [1..20]
:}
#+end_src

#+RESULTS: bb9d9079-206c-4d09-ae0a-aef93214012b
...
: <interactive>:43:1-9: warning: [-Wtype-defaults]
:     • Defaulting the type variable ‘a0’ to type ‘Integer’ in the following constraints
:         (Show a0) arising from a use of ‘print’ at <interactive>:43:1-9
:         (Integral a0) arising from a use of ‘it’ at <interactive>:43:1-9
