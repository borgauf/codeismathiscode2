...
+ Various operation and binder symbols, i.e., $+$, $-$, $\sum$ for summation,
  $\int$ for integration, et cetera.

Without getting too philosophical, we may stop and marvel at how
...
come back to what is meant by a symbol in the computer world.
...
[fn:10] Now, is Professor Smullyan saying ignorance is bliss?
