...
* Discrete Math Using a Computer 1
...
#+begin_src haskell :eval never :exports code :tangle ./src/dmuac1.hs :noweb yes
module DMUAC1 where
...
value as its first element. Use a ~Maybe~ type to indicate whether the
