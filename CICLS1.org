...
#+EXPORT_FILE_NAME: ComputingInContextLittleSchemer1.html
...
@@html:<font color = "#0d3db3">@@ ⇲ **The Ten Commandments**
...
@@html:<font color = "#0d3db3">@@⇲ **The Five Rules**
...
ground-breaking book [[https://en.wikipedia.org/wiki/G%C3%B6del,_Escher,_Bach][Gödel, Escher, Bach]] (1979). You might peruse the
...
*** A theoretical list world according to Aunt Rózsa

To the Hungarian mathematician Rózsa Péter, everything in the
...
In RFICT Péter says, a /list/ is a /finite __set__ of ordered
...
[fn:68] Βιγ Σξηεμερ: Big Schemer; Λιττλε Σξηεμερ: Little Schemer in
Greek letters.
...
[fn:51] Here the symbol ⊕ means any binary operation, e.g., addition,
subtraction...
...
[fn:21]  𝖟𝕭 is the German abbreviation for /zum Beispiel/ meaning "for
example," done in the old-fashioned German /Fraktur/ script, a nod to
all the German-speaking contributors to higher math.

[fn:20] **axiom**: From the Greek /axíōma/ meaning /for that which
