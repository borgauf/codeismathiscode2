...
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ Right, it's where
...
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ So all integers
...
matter. \\
[murmurs of agreement] \\
@@html:<span class="fraktur">@@𝔘𝔯𝔰𝔲𝔩𝔞:@@html:</span>@@ Lots of lore
around primes. \\
[more murmurs of agreement] @@html:<span
class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ So do you remember back in
...
[affirmative murmurs] \\
@@html:<span class="fraktur">@@𝔘𝔯𝔰𝔲𝔩𝔞:@@html:</span>@@ Yes, right,
...
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ When we had that
class we also talked about why the Greeks said, for example, $7$
/measures/ $35\;$. Yeah, so that means $7$ /divides/ $35$ evenly, no
remainder. And then there was /[[https://en.wikipedia.org/wiki/Commensurability_(mathematics)][commensurable]]/ and /incommensurable/,
...
@@html:<span class="fraktur">@@𝔘𝔯𝔰𝔲𝔩𝔞:@@html:</span>@@ [calling up
...
length. \\
@@html:<span class="fraktur">@@𝔘𝔴𝔢:@@html:</span>@@ But then doesn't
unit $1$ always wind up being the common measure? \\
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ Because two line
...
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ Let's bring it
...
@@html:<span class="fraktur">@@𝔘𝔱𝔢:@@html:</span>@@ No problem. We
...
and there's the trick to turn any decimal into a rational of just
integers. For example for $.756$, we just imagine it as

\begin{align*}
\frac{.756}{1}
\end{align*}

then there are three decimal places, so multiplying top and bottom by
$1,000$ gets it out of decimal and into integers in a ratio like we
want, then we reduce

\begin{align*}
\frac{756}{1000} = \frac{378}{500}
\end{align*}
